...
// Dodajemy usługi REST, które zdefiniowaliśmy w plikach „users.js” i „posts.js”
// znajdujących się w podkatalogu „routes”
...
const dbConnData = {
    ...
    database: process.env.MONGO_DATABASE || 'lab03'
};
